...
namespace AirConditionerFactory
{
    ...
    {
        public override IAirConditioner Create(double temp) => new CoolingManager(temp);
    }
    public class WarmingFactory : AirConditionerFactory
    {
        public override IAirConditioner Create(double temp) => new WarmingManager(temp);
    }
